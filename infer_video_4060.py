#!/usr/bin/env python3
"""
Simple inference script to generate N frames from a prompt using a base model + LoRA adapters.
...
def main():
    ...
    noise_scheduler = DDPMScheduler.from_pretrained(args.model_id, subfolder="scheduler") if False else DDPMScheduler(beta_start=0.00085, beta_end=0.012, beta_schedule="scaled_linear")
